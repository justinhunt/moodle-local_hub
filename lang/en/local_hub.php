...
$string['searchformprivate']= 'private (only logged in users)';
$string['searchformpublic']= 'public (all users)';
$string['searchformnone']= 'none (no search form)';
$string['searchform'] = 'Front page search';
$string['searchform_help'] = 'If private only logged in users see the course search form on the front page. If public the course search form will also be shown to users not logged in. Note that if the hub privacy is set to private, users will need to be logged in to see the course search form.';
